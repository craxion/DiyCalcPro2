                  ...
                  {calculator.id === 'concrete-slab-calculator' && (
                    <div id="concrete-slab-printable-results">
                      <div className="result-section bg-gradient-to-r from-grey-100 to-grey-200 p-6 rounded-2xl border border-grey-300">
                        ...
                        <div className="space-y-3">
                          <div className="result-row flex justify-between items-center">
                            <span className="result-label text-grey-600">Base Volume:</span>
                            <span className="result-value font-bold text-grey-800">{results.volume} cubic feet</span>
                          </div>
                          <div className="result-row flex justify-between items-center">
                            <span className="result-label text-grey-600">With Waste Factor:</span>
                            <span className="result-value font-bold text-grey-800">{results.volumeWithWaste} cubic feet</span>
                          </div>
                          <div className="result-row highlight-row flex justify-between items-center pt-2 border-t border-grey-300">
                            <span className="result-label font-bold text-primary-600">Total Cubic Yards:</span>
                            <span className="result-value highlight-value font-bold text-primary-600 text-xl">{results.cubicYards} yards³</span>
                          </div>
                        </div>
                      </div>
                      <div className="result-section bg-gradient-to-r from-success-100 to-success-200 p-6 rounded-2xl border border-success-300">
                        ...
                        <div className="space-y-3">
                          <div className="result-row flex justify-between items-center">
                            <span className="result-label text-success-700">Concrete Bags (80lb):</span>
                            <span className="result-value font-bold text-success-800">{results.bags} bags</span>
                          </div>
